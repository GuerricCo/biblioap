package com.bibli.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.bibli.service.UsernameAlreadyUsedException
        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
        if (
            ex instanceof com.bibli.service.EmailAlreadyUsedException
    ...
    private HttpStatus getMappedStatus(Throwable err) {
        ...
        if (err instanceof DataIntegrityViolationException) return HttpStatus.BAD_REQUEST;
        return null;
    }
    ...
    private boolean containsPackageName(String message) {
        ...
        return Strings.CS.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.bibli");
    }
}
