...
describe('Author Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Author', () => {
      ...
      service.create(author).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Author', () => {
      ...
      service.update(author).subscribe(resp => (expectedResult = resp));
    ...
    describe('addAuthorToCollectionIfMissing', () => {
      it('should add a Author to an empty array', () => {
        ...
        expect(expectedResult).toEqual([author]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([author, author2]);
      });
